/**
 * SolidJS Example - Signal-Σ with SolidJS
 * Demonstrates how Signal-Σ works seamlessly with SolidJS reactivity
 */
...
const Counter: Component = () => {
  ...
  return (
    <div class="p-4 border rounded">
      <h3 class="text-lg font-bold mb-2">SolidJS Counter</h3>
      <p>Count: {count()}</p>
      <p>Doubled: {doubled()}</p>
...
const StateMachineDemo: Component = () => {
  ...
  return (
    <div class="p-4 border rounded">
      <h3 class="text-lg font-bold mb-2">SolidJS State Machine</h3>
...
const FetchDemo: Component = () => {
  ...
  return (
    <div class="p-4 border rounded">
      <h3 class="text-lg font-bold mb-2">SolidJS Fetch</h3>
...
const FormDemo: Component = () => {
  ...
  const [theme, setTheme] = usePersistentSignal('solid-theme', 'light');

  return (
    <div class="p-4 border rounded">
      <h3 class="text-lg font-bold mb-2">SolidJS Form & Utils</h3>
...
const App: Component = () => {
  return (
    <div class="container mx-auto p-8">
      <h1 class="text-3xl font-bold mb-8">Signal-Σ + SolidJS Examples</h1>
      ...
      <div class="mt-8 p-4 bg-blue-50 rounded">
        ...
        <ul class="list-disc list-inside space-y-1 text-sm">
          <li><strong>useSignal:</strong> Basic reactive state (SolidJS createSignal)</li>
          <li><strong>useComputed:</strong> Derived values (SolidJS createMemo)</li>
